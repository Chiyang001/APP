        ...
        function displayResults(filteredProducts) {
            ...
            if (filteredProducts.length === 0) {
                ...
                filteredProducts.forEach(product => {
                    ...
                    listItem.innerHTML = `<strong>${product.name}</strong> - 描述：${product.description} - <button-search><a href="${product.downloadUrl}" target="_blank"  style="text-decoration: none;"><span style="color: #ffd700;">下载</a></button-search>`;
