      ...
      { name: '扫雷经典版', description: '' , downloadUrl: '' },
      { name: '腕间图库', description: '' , downloadUrl: '' },
      { name: '龙卷风收音机', description: '' , downloadUrl: '' },
      { name: '音乐播放器', description: '' , downloadUrl: '' },
      { name: '云谷云盘', description: '' , downloadUrl: '' },
