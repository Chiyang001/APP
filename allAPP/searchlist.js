      ...
      { name: 'LeiDell', description: '打开之后LeiDell会撅你！' , downloadUrl: 'https://LeiDell.cn/' }, 
      ...
      { name: 'MT管理器VIP破解版', description: '一款已经破解并获取VIP权限的MT管理器' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/8dfab4872d88da559f81186c8029abfc.apk' },
      { name: '玩具熊的午夜后宫2', description: '一款很好玩的游戏有点恐怖' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/936d403efab81fa8b8d96f800a65699c.apk' },
      { name: '玩具熊的午夜后宫3', description: '一款很好玩的游戏有点恐怖' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/6b1864e8966553ef84d4019535e8f166.apk' },
      { name: '玩具熊的午夜后宫4', description: '一款很好玩的游戏有点恐怖' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/3def7ce9231ef3e5b3eb0180db539882.apk' },
      { name: 'MC PE合集(3款)', description: '[压缩文件Zip需解压][版本:0.14.3]，但材质包不同，4x游玩需修改分辨率,应用投稿:loser' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/74f8d6f1e7a84a5cf376fd3bfd70b112.zip' },
      { name: 'P.N.F.', description: '一款非常好玩的游戏体积还小，应用投稿者：loser' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/faeb2d89bfa66d81eeec4b5b780da81d.apk' },
      { name: '欧陆战争3mod', description: '[已改右滑] 一款非常好玩的游戏mod版,应用投稿者：loser' , downloadUrl: 'https://fel.forxhr.top:2022/down.php/5967ce14680cbfe98d690af0278e478a.apk' },
      { name: '文明1全世界', description: '一款非常好玩的游戏，应用投稿者：loser' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/a5f9f151cd157c4c55b3525586a737f8.apk' },
      { name: '静读天下专业版', description: '一款非常好玩的阅读软件是专业版' , downloadUrl: 'https://fel.forxhr.top:2022/down.php/9b1105f161665e91751b1f6b855efe0a.apk' },
      { name: '蛋仔派对', description: '云蛋仔派对，可玩，拉上你的蛋搭子来一场手表之间的对决吧！' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/cbf5af12c1c89c3dae58a9432261c918.apk' },
      { name: '我的世界0.14.3服务器ip及端口', description: '我的世界0.14.3服务器ip及端口，怎么添加自己摸索傻子都会，文件格式为txt，打开后是服务器及端口，服务器搜集者：loser' , downloadUrl: 'https://fel.forxhr.top:2022/down.php/7207b138ed8f2b1de0d75fd5004b992f.txt' },
      { name: '小猫钓鱼', description: '一款简单休闲的小游戏' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/12e62c1d079fe11487436874ee15fa6e.apk' },
      { name: '微信', description: '虽是儿童版但可以打字的微信，增加了文字输入的功能，非常实用' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/efcb2aa2f6557342a10f13c7363b97f4.apk' },
      { name: 'QQ', description: '一款UI简洁，优化很好的QQ，更逆天的是，双击消息还可以朗读！打字输入，而且内置输入法，还可看动态发图片等超多功能！！' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/59d6ffb31982b3d1a74d29da69b06735.apk' },
      { name: '钓鱼锦标赛', description: '钓鱼......' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/712866111090bdd2c089ac3e911009d0.apk' },
      { name: '设备信息pro版', description: '[建议dpi<=175]设备信息Pro无广告版功能齐全，比aid64更加简洁明了，还可以多方面清理内存' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/3486196c28823ddc84ed44eca830b4f1.apk' },
      { name: '抖音短视频', description: '抖音短视频，能登录能搜索视频' , downloadUrl: 'https://fel1.forxhr.top:2022/down.php/66526423ea29b775b1929226159bdb50.apk' },
      { name: 'BiliYou', description: '[已改右滑]一款第三方的B站与哔哩终端功能相近，可登录' , downloadUrl: 'https://fel.forxhr.top:2022/down.php/7fe61ad6927f087103be662fa0d055bb.apk' },
      ...
      { name: '迁跃社区', description: '「迁跃社区」是一款手表上最优质的智能手表在线交流论坛' , downloadUrl: 'https://fel.forxhr.top:2022/down.php/fd82c653bd677058b1077018fb5744cf.apk' },
