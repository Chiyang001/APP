...
<h1>6/1更新 版本：2.2.5</h1>
    <ui>
      ...
      <li>1.新增1个应用</li>
      <li>2.删除页面'问题答疑'</li>
      <li>3.在菜单里新增子菜单，破解教程分为:破解教程，图文教程，专项专选[暂无]，问题答疑[暂无]</li>
      <li>4.将'问题答疑'修改为'图文教程'</li>
      <li>5.把'应用库'页面的旧菜单修改新菜单</li>
      <li>6.把'更新内容'中的菜单修改为一个按钮:'返回主页'</li>
      <li>7.创建文件夹'all lesson'将'破解教程'和'图文教程'移动到此文件夹</li>
    </ui> 
